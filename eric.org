...
#+END_SRC
* Magit
Set some basic keybindings for magit, historial emacs vc mode is C-x v <command>
  #+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c v c") 'magit-branch-and-checkout)
  (global-set-key (kbd "C-c v o") 'magit-checkout)
  #+END_SRC
